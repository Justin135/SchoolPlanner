...
class Todo(db.Model):
    ...
    startTime = db.Column(db.String(200), nullable=False) # Left as a string for now, may have to be changed to however format works
    endTime = db.Column(db.String(200), nullable=False) # Left as a string for now
